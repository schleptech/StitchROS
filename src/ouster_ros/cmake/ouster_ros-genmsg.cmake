...
set(MSG_I_FLAGS "-Iouster_ros:/home/stitch0001/catkin_WS/src/ouster_ros/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/stitch0001/catkin_WS/src/ouster_ros/srv/OSConfigSrv.srv" NAME_WE)
add_custom_target(_ouster_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ouster_ros" "/home/stitch0001/catkin_WS/src/ouster_ros/srv/OSConfigSrv.srv" ""
)

get_filename_component(_filename "/home/stitch0001/catkin_WS/src/ouster_ros/msg/PacketMsg.msg" NAME_WE)
add_custom_target(_ouster_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ouster_ros" "/home/stitch0001/catkin_WS/src/ouster_ros/msg/PacketMsg.msg" ""
)
...
_generate_msg_cpp(ouster_ros
  "/home/stitch0001/catkin_WS/src/ouster_ros/msg/PacketMsg.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ouster_ros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ouster_ros\")")
  # install generated code
  install(
