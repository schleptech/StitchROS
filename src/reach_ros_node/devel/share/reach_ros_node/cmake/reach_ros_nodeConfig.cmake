...
if("TRUE" STREQUAL "TRUE")
  set(reach_ros_node_SOURCE_PREFIX /home/stitch0001/catkin_WS/src/reach_ros_node)
  set(reach_ros_node_DEVEL_PREFIX /home/stitch0001/catkin_WS/src/reach_ros_node/devel)
  ...
  set(reach_ros_node_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'reach_ros_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stitch0001/catkin_WS/src/reach_ros_node/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT reach_ros_node_NUM_DUMMY_TARGETS)
      set(reach_ros_node_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::reach_ros_node::wrapped-linker-option${reach_ros_node_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR reach_ros_node_NUM_DUMMY_TARGETS "${reach_ros_node_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::reach_ros_node::wrapped-linker-option${reach_ros_node_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND reach_ros_node_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/stitch0001/catkin_WS/src/reach_ros_node/devel/lib;/home/stitch0001/catkin_WS/devel/lib;/opt/ros/melodic/lib)
